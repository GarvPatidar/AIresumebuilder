...
//                 {
//                     colors.map((color)=>(
//                         <div key={color.value} className='re
                        
//                         lative cursor-pointer group flex flex-col ' onClick={()=>{onChange(color.value); (!isOpen)}}>
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        ring-purple-300 hover:ring transition-all
      ...
      {isOpen && (
        ...
        p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm">
          {colors.map((color) => (
            <div
              key={color.value}
