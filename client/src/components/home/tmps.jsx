...
//      </button>
//      </div>
//      <hr className='border-slate-300 my-6 s,:w-[305px]'/>
//      <div className="grid grid-cols-2 sm:flex flex:wrap gap-4 ">
// {allResume.map((resume,index)=>{
// const basecolor=colors[index%colors.length];
// return (
//   <button key={index} className='realtive w-full sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer'style={{background: `linear-gradient(135deg,${basecolor}10,${basecolor}40`,borderColor: basecolor+ '40'}}>
//     <FilePenLineIcon className='size--7 group-hover:scale-105 transition-all' style={{color:basecolor}}/>
//     <P className='text-sm group-hover:scale-105 transition-all px-2 text-center'style={{color:basecolor}}>{resume.tittle}</P>
//   <p className='absolute buttom-1 text-[11px] text-slate-400 group-hover:text-slate-500 transition-all duration-300 px-2 text-center'style={{color: basecolor+'90'}}>
