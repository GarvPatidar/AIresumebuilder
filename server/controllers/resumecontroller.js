// //conttroller for creating a new resume 
...
// //return succes mesage
// return res.status(201).json({message:'Resume Created succcesfully',resume:newResume})
//     }
//     catch(error){
...
// //return succes mesage
// return res.status(200).json({message:'Resume deleted succcesfully'})
//     }
//     catch(error){
// return res.status(400).json({message:error.message})
//     }
