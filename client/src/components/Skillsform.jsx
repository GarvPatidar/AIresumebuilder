  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
         <input type="text" placeholder='Enter s skill (e.g. javascript,project management )' className='flex-1 px-3 py-2 text-sm' onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
     ...
     <div className='text-center py-6 text-gray-500' > 
      ...
      <div className='bg-blue-50 p-3 rounded-lg'>
        <p className='text-sm text-blue-800 '><strong>Tip:</strong>Add 8-12 revelenat skills.Include both technical and soft skills</p>
      </div>
    </div>
  )
}
