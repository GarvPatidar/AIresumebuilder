  ...
  return (
    <div className='space-y-4'>
      ...
      <textarea
        ...
        rows={7}
        className='w-full p-3 mt-2 border text-sm border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 outline-none resize-none'
        placeholder='Write your professional summary'
      />

      <p className='text-xs text-gray-500 text-center'>
        Tip: Keep it concise (3–4 sentences) and focus on key achievements.
      </p>
    </div>
  )
}
